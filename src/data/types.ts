export type OreType = 'vorax' | 'krysite' | 'gas' | 'steel_bars' | 'steel_plates' | 'compressed_gas' | 'water' | 'alloy_rods' | 'rocket_fuel' | 'shards' | 'aethite' | 'void_cores' | 'processed_rations' | 'bio_resin' | 'processed_resin' | 'power_cells' | 'bio_circuit_boards' | 'dark_gas' | 'void_touched_ore' | 'resonance_shards' | 'ferrovoid' | 'warp_components' | 'crystal_lattice' | 'drill_head' | 'hull' | 'engine' | 'fuel_tank' | 'avionics' | 'landing_gear' | 'iron_ore' | 'copper_ore' | 'iron_bar' | 'copper_bar' | 'hydrolox_fuel';
